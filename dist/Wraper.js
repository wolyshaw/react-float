...
var containerStyle = _defineProperty({ display: 'flex', overflowY: 'auto', width: '100%', maxHeight: '100%' }, 'overflowY', 'auto');
  ...
  _createClass(Wraper, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: this.props.className, style: wraperStyle },
        _react2.default.createElement(
          'span',
          { className: 'float-container', onClick: this.props.close, style: containerStyle },
          _react2.default.createElement(
            'span',
            { onClick: function onClick(e) {
                return e.stopPropagation();
              }, style: Object.assign({ margin: '20px auto' }, this.props.spanStyle) },
            this.props.children
          )
        )
      );
