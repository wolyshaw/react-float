...
var float = function () {
  ...
  _createClass(float, [{
    ...
    value: function create() {
      ...
      var newProps = Object.assign({}, initProps, props);
      (0, _reactDom.render)(_react2.default.createElement(
        _Wraper2.default,
        _extends({}, newProps, { mask: this.mask, maskClose: this.maskClose, spanStyle: this.spanStyle }),
        Component ? _react2.default.createElement(Component, newProps) : _react2.default.createElement(FloatComponent, newProps)
      ), this.warper);
